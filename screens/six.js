        ...
        <View style={styles.body}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                <TextInput
                    ...
                    placeholder="Search..."
                />
                <Image source={require('./images/1.png')} style={{ width: 24, height: 24, margin: 5, position: 'absolute', left: 5 }}></Image>
                <Image source={require('./images/1.png')} style={{ width: 24, height: 24, right: 58, }}/>
                <View style={{ width: 40, height: 40, borderRadius: 50, backgroundColor: 'green', }}>
                    <Image source={require('./images/1.png')} style={{ width: 24, height: 24, left: 10, top: 8, }}/>
                </View>
            </View>
                    ...
                    <View style={{ width: 200, height: 240, borderRadius: 30, backgroundColor: 'white', }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                            ...
                            <View style={{ width: 40, height: 40, borderRadius: 50, backgroundColor: 'green', top:58,right:10,}}>
                                    <Image source={require('./images/1.png')} style={{ width: 24, height: 24,top: 8, }}></Image>
                                </View>
                        </View>
                    </View>
                    <View style={{ width: 200, height: 240, borderRadius: 30, backgroundColor: 'white', }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                            ...
                            <View style={{ width: 40, height: 40, borderRadius: 50, backgroundColor: 'green', top:58,right:10,}}>
                                    <Image source={require('./images/1.png')} style={{ width: 24, height: 24,top: 8, }}/>
                                </View>
                        </View>
                    </View>
                    <View style={{ width: 200, height: 240, borderRadius: 30, backgroundColor: 'white', }}>
